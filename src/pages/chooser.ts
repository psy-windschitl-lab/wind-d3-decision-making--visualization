...
export function renderVersionChooser(root: HTMLElement, ctx: Parameters<Page>[1]) {
  ...
  section.innerHTML = `
    ...
    <div>
      ...
      <p style="font-family:monospace; word-break:break-all"><span style="color:white">https://forpwplaying1.d3cre5pk9b538u.amplifyapp.com/</span><span style="color:#ffd60a">?layout=GP2&amp;wadd=checkbox&amp;intro=Intro1</span></p>
