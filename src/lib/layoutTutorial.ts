...
const STEPS: Step[] = [
  ...
  },
  {
    ...
    text: "To find Julie\u2019s <strong>BEST OVERALL</strong> option, you simply find the one with the most green under it.<br><br>Here, we can see there is slightly more green under Option C.",
    buttonLabel: "Next",
